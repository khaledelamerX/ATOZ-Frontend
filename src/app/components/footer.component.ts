      ...
      <div class="container-max py-8 text-sm text-slate-600">
        <div class="grid md:grid-cols-2 gap-6 items-start">
          <div>
            ...
            <div class="text-sm">الهاتف: <a href="tel:+201000000000" class="text-slate-700 hover:text-slate-900">+20 100 000 0000</a></div>
            <div class="mt-3 text-sm">بريد إلكتروني: <a href="mailto:info@atoz.com" class="text-slate-700 hover:text-slate-900">info@atoz.com</a></div>
          </div>
          <div class="text-sm">
            ...
            <div class="mt-4">
              ...
              <div class="flex gap-3">
                <a href="#" aria-label="Facebook" class="text-slate-600 hover:text-slate-900">Facebook</a>
                <a href="#" aria-label="Instagram" class="text-slate-600 hover:text-slate-900">Instagram</a>
